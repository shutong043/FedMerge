...
parser.add_argument('--num-class-per-cluster', default='[100]', type=str, help='choose the number of class per cluster in dataset,for example,[3,3,3,3,3] means five clusters, three class per cluster')
